...
double r21(double phi, double kapa) { return (-cos(phi) * sin(kapa)); }
...
double r31(double phi) { return (sin(phi)); }
double r32(double omega, double phi) { return (-sin(omega) * cos(phi)); }
double r33(double omega, double phi) { return (cos(omega) * cos(phi)); }
